...
- GuiTools should work with all recent [QB64-PE (Phoenix Edition)](https://github.com/QB64-Phoenix-Edition/QB64pe/releases) versions and also with the older [QB64 (QB64Team)](https://github.com/QB64Team/qb64/releases) versions. However, while GuiTools itself is pretty much backward compatible, note that some applications made with GuiTools may have stricter QB64 version requirements.
...
|Easy customizing with the GuiTools Preferences Editor|
|:---:|
...
|:---:|:---:|
|![LogicTrainer](LogicTrainer.png)|![MakeDATA](MakeDATA.png)|

<br>

|And even multi-window Applications|
|:---:|
